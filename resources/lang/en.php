...
return [
    ...
    'device.confirm_install_title' => 'Install the waiting updates on :name?',
    'device.confirm_install_detail' => 'Waiting: :count. Carried out at its next check-in, and its output streams to the machine\'s page as it runs.',
    'device.confirm_install_detail_security' => 'Waiting: :count, :security of them security. Carried out at its next check-in, and its output streams to the machine\'s page as it runs.',
    'device.confirm_reboot_title' => 'Restart :name?',
    'device.confirm_reboot_detail' => 'Carried out at its next check-in, with a minute\'s warning on the machine. Anyone using it will be interrupted.',
    'device.check_updates_all' => 'Check for updates',
    'device.check_updates_all_confirm' => 'Check for updates on every machine in this list?',
    'device.check_updates_all_detail' => 'Each goes out to its own update sources for a fresh list — apt-get update, softwareupdate or a Windows Update scan — at its next check-in, and this list shows what is waiting as they report. Nothing is installed.',
